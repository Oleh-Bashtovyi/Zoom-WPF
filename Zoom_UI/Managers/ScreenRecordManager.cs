...
namespace Zoom_UI.Managers
{
    public class ScreenRecordingManager : IDisposable
    {
        ...
        private const string args = "-f gdigrab -framerate 30 -draw_mouse 0 -i title=\"MainWindow\"";
        ...
        public ScreenRecordingManager()
        {
            ...
            _ffmpegProcess.StartInfo.Arguments = $"{GetArgs()} {_outputPath}\\{_tempName}";
        ...
        {
            return $"-f gdigrab -framerate 30 -draw_mouse 1 -i title=\"MyZoom\" -c:v libx264 -preset ultrafast -tune zerolatency";
        }
